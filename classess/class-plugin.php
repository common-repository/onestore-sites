<?php
class OneStore_Sites_Plugin extends TGM_Plugin_Activation {
	...
	function ajax() {
		...
		} elseif ( $action == 'cs_active_plugin' ) {
	...
	function do_register_plugin( $slug ) {
		...
		$config = array(
			'id'           => 'onestore-sites-plugins',       // Unique ID for hashing notices for multiple instances of TGMPA.
